...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catalog_product', (
            ...
            ('old_price', self.gf('django.db.models.fields.DecimalField')(default=0.0, null=True, max_digits=9, decimal_places=2, blank=True)),
            ('plu_number', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ...
        m2m_table_name = db.shorten_name('catalog_product_categories')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('catalog_product_categories'))
