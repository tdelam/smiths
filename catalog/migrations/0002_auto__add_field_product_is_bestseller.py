...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.is_bestseller'
        db.add_column('catalog_product', 'is_bestseller',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.is_bestseller'
        db.delete_column('catalog_product', 'is_bestseller')
