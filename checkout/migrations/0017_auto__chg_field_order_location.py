...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.location'
        db.alter_column('checkout_order', 'location', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Order.location'
        db.alter_column('checkout_order', 'location', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'checkout.order': {
            ...
            'location': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
