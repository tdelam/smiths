...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('checkout_order', (
            ...
            ('shipping_state_province', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
            ('shipping_zip_postal', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ...
            ('billing_zip_postal', self.gf('django.db.models.fields.CharField')(max_length=10)),
