...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderItem.pickup_date'
        db.add_column('checkout_orderitem', 'pickup_date',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'OrderItem.pickup_time'
        db.add_column('checkout_orderitem', 'pickup_time',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderItem.pickup_date'
        db.delete_column('checkout_orderitem', 'pickup_date')

        # Deleting field 'OrderItem.pickup_time'
        db.delete_column('checkout_orderitem', 'pickup_time')
