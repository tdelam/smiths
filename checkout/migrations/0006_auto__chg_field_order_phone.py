...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.phone'
        db.alter_column('checkout_order', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Order.phone'
        db.alter_column('checkout_order', 'phone', self.gf('django.db.models.fields.CharField')(max_length=50))
