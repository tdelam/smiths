...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.shipping_zip_postal'
        db.delete_column('checkout_order', 'shipping_zip_postal')

        # Deleting field 'Order.shipping_state_province'
        db.delete_column('checkout_order', 'shipping_state_province')

        # Deleting field 'Order.shipping_city'
        db.delete_column('checkout_order', 'shipping_city')


    def backwards(self, orm):
        # Adding field 'Order.shipping_zip_postal'
        db.add_column('checkout_order', 'shipping_zip_postal',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.shipping_state_province'
        db.add_column('checkout_order', 'shipping_state_province',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.shipping_city'
        db.add_column('checkout_order', 'shipping_city',
