...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.notes'
        db.alter_column('checkout_order', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Order.notes'
        db.alter_column('checkout_order', 'notes', self.gf('django.db.models.fields.TextField')(default=2))
