...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostalCodeShipping.price'
        db.alter_column('checkout_postalcodeshipping', 'price', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

    def backwards(self, orm):

        # Changing field 'PostalCodeShipping.price'
        db.alter_column('checkout_postalcodeshipping', 'price', self.gf('django.db.models.fields.DecimalField')(default='', max_digits=9, decimal_places=2))
    ...
    models = {
        ...
        'checkout.postalcodeshipping': {
            ...
            'price': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'})
        },
