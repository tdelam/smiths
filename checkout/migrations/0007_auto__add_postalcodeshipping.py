...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PostalCodeShipping'
        db.create_table('checkout_postalcodeshipping', (
        ...
        db.send_create_signal('checkout', ['PostalCodeShipping'])


    def backwards(self, orm):
        # Deleting model 'PostalCodeShipping'
        db.delete_table('checkout_postalcodeshipping')
