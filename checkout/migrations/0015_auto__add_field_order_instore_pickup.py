...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.instore_pickup'
        db.add_column('checkout_order', 'instore_pickup',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.instore_pickup'
        db.delete_column('checkout_order', 'instore_pickup')
