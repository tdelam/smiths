...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderItem.delivery_date'
        db.add_column('checkout_orderitem', 'delivery_date',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'OrderItem.delivery_time'
        db.add_column('checkout_orderitem', 'delivery_time',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderItem.delivery_date'
        db.delete_column('checkout_orderitem', 'delivery_date')

        # Deleting field 'OrderItem.delivery_time'
        db.delete_column('checkout_orderitem', 'delivery_time')
    ...
    models = {
        ...
        'checkout.order': {
            ...
            'shipping_state_province': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'shipping_zip_postal': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
        ...
        'checkout.orderitem': {
            ...
            'delivery_date': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
