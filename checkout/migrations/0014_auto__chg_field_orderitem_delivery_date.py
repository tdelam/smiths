...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderItem.delivery_date'
        db.alter_column('checkout_orderitem', 'delivery_date', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'OrderItem.delivery_date'
        db.alter_column('checkout_orderitem', 'delivery_date', self.gf('django.db.models.fields.IntegerField')())
